...
<body>
	...
	<div class="w3-top">
		...
		<form action="logout">
			<div class="w3-bar w3-white w3-card" id="myNavbar">
				...
				<%= getServletContext().getInitParameter("appname") %>  </a>
				
				
				
				
				<!-- Right-sided navbar links -->
				<div class="w3-right w3-hide-small"> <input type="submit" class="w3-bar-item w3-button"
	...
	<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
		<div class="w3-display-left w3-text-white" style="padding: 48px">
			<span class="w3-jumbo w3-hide-small">Welcome
			
			
			 <%= request.getAttribute("fname") %>
			 
			 
			</span><br> <span class="w3-xxlarge w3-hide-large w3-hide-medium">Welcome
				<%=request.getAttribute("fname")%>
			</span><br> <span class="w3-large">Your Id Card is available to
				print.</span>
			<p>
				<a href="card"
					class="w3-button w3-white w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-off">Preview card</a>
			</p>
		</div>
